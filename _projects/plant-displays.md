---
layout: project
title: "Plant Displays Series"
description: "An ongoing botanical modeling collection featuring detailed artistic representations of selected plant species, from roots to flowers"
date: 2024-01-01
...
techniques:
  - "Resin casting"
  - "Flower pressing"
  - "Wood carving (roots, bulbs, corms)"
  - "Paper flower construction"
  - "Clay modeling"
  - "Leaf pressing and preservation"
  - "Seed encapsulation (DC fix and Perspex)"
  - "Miniature diorama construction"
  - "Display board design and layout"
materials:
  - "Natural plant materials (pressed flowers, leaves, seeds)"
  - "Resin (for casting)"
  - "Wood (for root systems)"
  - "Paper (for flower construction)"
  - "Air-dry clay"
...
### Ranunculus
<img src="{{ 'assets/images/projects/plant-displays/ranunculus/gallery/ran-gallery-002.jpg' | relative_url }}" alt="Ranunculus display" style="float: right; width: 300px; margin: 0 0 1em 1em;">
...
### Snowdrops
<img src="{{ 'assets/images/projects/plant-displays/snowdrops/gallery/sno-gallery-004.jpg' | relative_url }}" alt="Snowdrops display" style="float: right; width: 300px; margin: 0 0 1em 1em;">
...
- **Hibiscus** - Unique and prominent stamen with large flower
- **Poinsettia** - large red flower
- **Primula** - wide range of flower shapes
- **Protea** - wide range of forms and large intricate flowers
- **strelizia** - uniquely formed flower
...
1. **Plant Selection** - Choosing species based on criteria (loved, dramatic, meaningful)
2. **Research** - Understanding plant structure, growth cycle, varieties
3. **Material Collection** - Gathering natural specimens, seeds, pressed flowers (may span multiple seasons)
4. **Design** - Planning board layout, determining which components to include
5. **Construction** - Creating individual components using various techniques:
   - Root system carving
   - Leaf pressing/resin casting
   - Flower construction (paper/clay/resin)
   - Seed encapsulation
   - Situational diorama elements
6. **Board Assembly** - Arranging components on display board
7. **Identification Plate** - Creating etched plate with details
8. **Documentation** - Photography and build log completion
