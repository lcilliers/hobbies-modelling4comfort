...
<div class="image-grid-2">
  <figure>
    <img src="{{ site.baseurl }}/assets/images/projects/caravaning/caravan/caravaning-caravan-024.jpg" alt="Eriba research">
    <figcaption>Research images of the Eriba Triton from multiple angles</figcaption>
  </figure>
  <figure>
    <img src="{{ site.baseurl }}/assets/images/projects/caravaning/caravan/caravaning-caravan-001.jpg" alt="Technical specs">
    <figcaption>Finding manufacturer specifications was invaluable</figcaption>
  </figure>
</div>
...
<figure>
  <img src="{{ site.baseurl }}/assets/images/projects/caravaning/caravan/caravaning-caravan-028.jpg" alt="Site visit">
  <figcaption>Visiting the actual campsite for reference photos and understanding</figcaption>
</figure>
...
<!-- NOTE: The 1:42 scale is unusual - most model cars are 1:43 (common die-cast scale) or 1:35/1:48 (military modeling). This means purchasing commercial vehicles wasn't an option. Everything had to be scratch-built to match the caravan scale. -->
...
<div class="image-grid-2">
  <figure>
    <img src="{{ site.baseurl }}/assets/images/projects/caravaning/planning/caravaning-planning-003.jpg" alt="Angle calculations">
    <figcaption>Using side-view photo to calculate front and rear angles</figcaption>
  </figure>
  <figure>
    <img src="{{ site.baseurl }}/assets/images/projects/caravaning/planning/caravaning-planning-002.jpg" alt="Cutting sheet">
    <figcaption>Rough cutting sheet with all calculated measurements</figcaption>
  </figure>
</div>
...
<figure>
  ...
  <figcaption>Finding this scratch-built example proved it was possible!</figcaption>
</figure>
...
<div class="image-grid-2">
  <figure>
    ...
    <figcaption>The exact car: VW Golf R Estate in red</figcaption>
  </figure>
  <figure>
    <img src="{{ site.baseurl }}/assets/images/projects/caravaning/car/caravaning-car-010.jpg" alt="Estate references">
    <figcaption>Multiple estate car references for proportions</figcaption>
  </figure>
</div>
...
<!-- NOTE: The decision to try air-dry clay was based on frustration with epoxy putty's short working time. Air-dry clay allows longer shaping and smoothing time before it hardens. This proved crucial for the extended work needed on vehicle curves. -->
...
**Next Build Log:** [002 - Caravan Construction](002-caravan-construction)
