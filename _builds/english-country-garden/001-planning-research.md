...
<div class="image-row-2">
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/base/ecg-base-002.jpg' | relative_url }}" alt="Initial layout prototype">
    <div class="caption">Early prototype exploring house and garden proportions on the base</div>
  </div>
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/base/ecg-base-003.jpg' | relative_url }}" alt="Paper house footprint">
    <div class="caption">Paper footprint prototype to assess space allocation</div>
  </div>
</div>
...
<div class="image-row-2">
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/cottages/ecg-plan-cot-002.jpg' | relative_url }}" alt="Cottage with small garden">
    <div class="caption">Perfect example of how the house will fit with a small garden</div>
  </div>
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/cottages/ecg-plan-cot-003.jpg' | relative_url }}" alt="Thatched roof and chimney">
    <div class="caption">The roof and chimney of this house resonated</div>
  </div>
</div>

<div class="image-row-2">
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/cottages/ecg-plan-cot-010.jpg' | relative_url }}" alt="Cottage with annex">
    <div class="caption">The annex and aging of this cottage appealed to me</div>
  </div>
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/cottages/ecg-plan-cot-014.jpg' | relative_url }}" alt="House with tree and path">
    <div class="caption">House with annex, tree, path in the middle - an appealing combination</div>
  </div>
</div>
...
<div style="text-align: center; margin: 20px 0;">
  <img src="{{ '/assets/images/projects/english-country-garden/planning/flowers/ecg-plan-flw-004.jpg' | relative_url }}" alt="Flower reference collage" style="max-width: 100%;">
  <div class="caption">Collage for display while building the flowers</div>
</div>
...
<div class="image-row-2">
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/flowers/ecg-plan-flw-005.jpg' | relative_url }}" alt="Inspirational garden 1">
    <div class="caption">Cottage garden with dense mixed plantings</div>
  </div>
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/flowers/ecg-plan-flw-007.jpg' | relative_url }}" alt="Inspirational garden 2">
    <div class="caption">Layered borders with varied heights and colors</div>
  </div>
</div>

<div class="image-row-2">
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/flowers/ecg-plan-flw-009.jpg' | relative_url }}" alt="Inspirational garden 3">
    <div class="caption">Path through lush plantings</div>
  </div>
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/flowers/ecg-plan-flw-010.jpg' | relative_url }}" alt="Inspirational garden 4">
    <div class="caption">Cottage surrounded by abundant flowers</div>
  </div>
</div>
...
<div class="image-row-3">
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/training-and-references/ecg-plan-ref-011.jpg' | relative_url }}" alt="Flower shapes reference 1">
    <div class="caption">Flower shape categories and techniques</div>
  </div>
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/training-and-references/ecg-plan-ref-015.jpg' | relative_url }}" alt="Plant structure reference">
    <div class="caption">Plant structure and leaf forms</div>
  </div>
  <div>
    <img src="{{ '/assets/images/projects/english-country-garden/planning/training-and-references/ecg-plan-ref-016.jpg' | relative_url }}" alt="Flower construction reference">
    <div class="caption">Flower construction methods</div>
  </div>
</div>
...
**Next Build Log:** [#002 - Flowers & Plant Creation](/builds/english-country-garden/002-flowers-plants/) - The heart of the project: materials preparation and crafting over 100 individual plants
