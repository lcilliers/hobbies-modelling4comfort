...
next_step: /builds/henrhyd-falls-south-wales/002-base/
next_step_title: "Base Construction"
---
...
![AI concept illustration]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-004.jpg' | relative_url }})
*AI-generated concept illustration showing how Henrhyd Falls could be represented at 1:250 scale on a 25×25cm base. This tranquil waterfall oasis visualization helped me see the potential for a captivating miniature forest scene with cascading waterfall.*

![Top-down layout]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-003.jpg' | relative_url }})
*Top-down layout diagram of the 25×25cm base showing the spatial arrangement of the cliff, waterfall, pool, and surrounding terrain. This scale planning document was critical for validating that the vertical 27m drop could work on the compact base.*
...
![Reference waterfall in forest]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-005.jpg' | relative_url }})
*Reference waterfall in lush forest setting. The serene beauty of this cascading waterfall in a secluded forest helped me understand the water flow patterns and the intimate relationship between water and surrounding vegetation.*

![Vertical waterfall drop]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-007.jpg' | relative_url }})
*Waterfall oasis showing vertical drop through verdant forest. This reference image was particularly useful for understanding how the white water cascade contrasts against dark rock and green foliage.*

![Waterfall mist effects]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-011.jpg' | relative_url }})
*Tranquil waterfall showing mist and spray effects at the base. This image helped me plan the water impact zone and understand how to represent the atmospheric moisture that characterizes Welsh waterfalls.*

### Henrhyd Falls Site Photos

![Henrhyd Falls with bridge]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-022.jpg' | relative_url }})
*Henrhyd Falls with wooden bridge walkway. This photo shows the actual site with the famous wooden bridge structure and gives a sense of the scale and surrounding landscape.*

![Henrhyd Falls full height]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-029.jpg' | relative_url }})
*Henrhyd Falls, Wales - showing the full height of the waterfall. This captivating view helped me understand the overall proportions and the dramatic vertical drop that defines this location.*

![Batman filming location]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-030.jpg' | relative_url }})
*Henrhyd Falls Batman film location in Brecon Beacons. This reference was valuable for understanding the cave formation behind the falls - the feature that made it famous as a filming location for The Dark Knight Rises.*

### Rock Formation Studies

![Welsh coastal rock layers]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-035.jpg' | relative_url }})
*Coastal rock formation showing layered sedimentary structure. While not from Henrhyd Falls itself, this majestic coastal landscape provided excellent reference for understanding Welsh geological stratification and weathering patterns.*

![Cliff face texture detail]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-041.jpg' | relative_url }})
*Detailed cliff face texture study. This meticulously detailed view captures the intricate patterns and textures of a rugged cliff face - invaluable for planning the rock carving and texturing techniques.*

### Welsh Woodland References

![Ancient oak in Welsh forest]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-046.jpg' | relative_url }})
*Ancient woodland tree in Welsh forest. This majestic arbor in enchanted woods shows the character of Welsh sessile oak and the moss-covered trunk texture that defines temperate rainforest environments.*

![Forest understory vegetation]({{ 'assets/images/projects/henrhyd-falls-south-wales/planning/hfs-planning-053.jpg' | relative_url }})
*Verdant forest understory vegetation. Exploring the enchanting depths of Welsh woodland helped me understand the dense, layered vegetation and the rich green palette needed for authentic representation.*
