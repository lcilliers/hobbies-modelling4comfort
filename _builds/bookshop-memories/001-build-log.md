---
layout: build
title: "Bookshop Memories - Build Log"
date: 2025-02-12
project: /projects/bookshop-memories/
categories: [miniature, kit-build, book-nook]
tags: [booknookkit, assembly, bookshop, led-lighting]
excerpt: "Building the Bookshop Memories DIY Book Nook Kit from BookNookKit.com - a charming miniature bookshop scene perfect for display."
build_log_menu:
  - url: /builds/bookshop-memories/001-build-log/
    title: "Build Log"
---
...
1. **Initial Review:** Worked through the instructions to familiarize myself with all parts
2. **Organization:** Kept parts in their numbered plastic pockets for easy access
3. **Discipline:** Parts remained in packaging until specifically called for in instructions
4. **Dry Fitting:** Test-fit each component before applying glue
5. **Surface Preparation:** Light sanding and smoothing for optimal fit
...
<div class="image-single">
  <img src="{{ 'assets/images/projects/bookshop-memories/bsm-002.jpg' | relative_url }}" alt="Construction progress" style="transform: rotate(90deg);">
  <div class="caption">Mid-build progress showing the bookshop structure taking shape</div>
</div>
...
<div class="image-single">
  <img src="{{ 'assets/images/projects/bookshop-memories/bsm-003.jpg' | relative_url }}" alt="Completed bookshop with lighting" style="transform: rotate(90deg);">
  <div class="caption">Completed Bookshop Memories displayed on the model table with LED lighting activated</div>
</div>

<div class="image-single">
  <img src="{{ 'assets/images/projects/bookshop-memories/bsm-004.jpg' | relative_url }}" alt="Final display piece">
  <div class="caption">The finished bookshop - a charming display piece perfect for any collection</div>
</div>
...
2. Keep parts organized in their original packaging
3. Dry-fit everything before gluing
4. Take your time with cutting - precision matters
5. Test the lighting before final assembly
6. Enjoy the process - this is a fun, satisfying build!
