...
| Script | Purpose |
|--------|---------|
| `../../scripts/imagemagick-optimize.ps1` | Resize, compress, convert images (includes HEIC) - **PRIMARY SCRIPT** |
| `../../scripts/new-build-log.ps1` | Create new build log from template |
| `../../scripts/copy-project-images.ps1` | Copy images from source to website structure |

**Note:** See [../../scripts/README.md](../../scripts/README.md) for complete script documentation
