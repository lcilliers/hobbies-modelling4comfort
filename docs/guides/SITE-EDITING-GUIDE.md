...
For detailed information about advanced image layouts in build logs, see **[IMAGE-LAYOUT-GUIDE.md](IMAGE-LAYOUT-GUIDE.md)** (same folder).
...
**→ See [IMAGE-LAYOUT-GUIDE.md](IMAGE-LAYOUT-GUIDE.md) (same folder) for complete examples and code samples**
