...
#
# THIS SCRIPT HAS BEEN DEPRECATED AND MOVED TO _deprecated/ FOLDER
#
# REASON: Unreliable HEIC/HEIF support. The Windows HEIF codec dependency
# is inconsistent and causes failures across different systems.
#
# USE INSTEAD: scripts\imagemagick-optimize.ps1
#
# The ImageMagick script:
# - Handles HEIC/HEIF files natively and reliably
# - Has been proven across all projects (log-cabin, traditional-english-cottage, etc.)
# - Supports green screen replacement
# - No external codec dependencies
#
# See scripts/README.md for correct usage.
# ⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️

Write-Host ""
Write-Host "╔════════════════════════════════════════════════════════════╗" -ForegroundColor Red
Write-Host "║                   ⚠️  DEPRECATED SCRIPT  ⚠️                  ║" -ForegroundColor Red
Write-Host "╠════════════════════════════════════════════════════════════╣" -ForegroundColor Red
Write-Host "║  This script has been DEPRECATED due to unreliable        ║" -ForegroundColor Yellow
Write-Host "║  HEIC/HEIF support.                                       ║" -ForegroundColor Yellow
Write-Host "║                                                           ║" -ForegroundColor Yellow
Write-Host "║  USE INSTEAD:  scripts\imagemagick-optimize.ps1           ║" -ForegroundColor Green
Write-Host "║                                                           ║" -ForegroundColor Yellow
Write-Host "║  See scripts/README.md for correct usage.                ║" -ForegroundColor Cyan
Write-Host "╚════════════════════════════════════════════════════════════╝" -ForegroundColor Red
Write-Host ""

$response = Read-Host "Do you REALLY want to use this deprecated script? (type 'YES' to continue)"
if ($response -ne "YES") {
    Write-Host "Good choice! Use imagemagick-optimize.ps1 instead." -ForegroundColor Green
    exit 0
}

Write-Host "⚠️ Proceeding with deprecated script at your own risk..." -ForegroundColor Yellow
Write-Host ""
