...
- **IMAGE-LAYOUT-GUIDE.md** - Image sizing and layout techniques
- **SITE-EDITING-GUIDE.md** - General site editing workflows
- **PUBLISHING-GUIDE.md** - Deployment and troubleshooting
